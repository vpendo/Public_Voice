...
export function AllIssues() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-slate-900 mb-2">All Issues</h1>
      <p className="text-slate-500 mb-8">View and respond to citizen reports.</p>
      ...
      {!loading && !error && reports.length === 0 && (
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-12 text-center">
          ...
          <p className="text-slate-500">Reports submitted by citizens will appear here.</p>
        </div>
      )}
