      ...
      <div className="max-w-xl space-y-6">
        <div className="rounded-2xl border border-slate-200/80 bg-white shadow-sm overflow-hidden">
          ...
          <div className="px-6 py-5 border-b border-slate-100 bg-slate-50/80">
            <h2 className="text-sm font-semibold text-slate-600 uppercase tracking-wider flex items-center gap-2">
              <User size={16} className="text-[var(--rwanda-blue)]" />
              {p.account}
            </h2>
          </div>
          <div className="p-6">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-16 h-16 rounded-full bg-[var(--rwanda-blue)] flex items-center justify-center text-white">
                <User size={32} />
              </div>
              <div>
            ...
            <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="rounded-xl bg-slate-50 p-4 sm:col-span-2">
                ...
                <dd className="mt-1">
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-sm font-medium bg-[var(--rwanda-blue-light)] text-[var(--rwanda-blue)]">
                    {user?.role ?? '—'}
                  </span>
                </dd>
              </div>
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-slate-100 bg-slate-50/80 flex items-center gap-2">
            <KeyRound size={18} className="text-[var(--rwanda-blue)]" />
            <h3 className="text-sm font-semibold text-slate-700">{p.changePassword}</h3>
          </div>
          <div className="p-6">
            {message && (
              <div className="mb-4 p-4 rounded-xl bg-[var(--rwanda-blue-light)] border border-[var(--rwanda-blue)]/20 text-[var(--rwanda-blue)] text-sm">
                {message}
              </div>
            )}
            <form onSubmit={handleChangePassword} className="space-y-4">
              ...
              <button
                type="submit"
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-[var(--rwanda-blue)] text-white font-semibold rounded-xl hover:opacity-95 transition-opacity"
              >
                {p.updatePassword}
              </button>
            </form>
