    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <Link
            to="/report"
            className="inline-flex items-center gap-2 px-10 py-4 bg-[var(--color-primary)] text-white font-semibold rounded-xl text-lg transition-all duration-300 shadow-lg hover:opacity-95 hover:scale-[1.02] active:scale-[0.98]"
          >
            {t.home.cta.button}
            <ArrowRight className="w-5 h-5" />
          </Link>
